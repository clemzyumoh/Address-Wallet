...
const Launchpad = () => {
  ...
  return (
    <div className="mb-28  pt-8 dark:bg-transparent">
      ...
      <div className=" mx-auto  w-[90vw] lg:w-[60vw] lg:h-[80vh] shadow-2xl mb-0 text-center">
        <img
          src={img}
          alt=""
      ...
      <div className="flex justify-center items-center flex-col">
        <AnimatedText
          ...
          animation="fade"
          as="h1"
          className="font-bold  mt-10 leading-[40px] tracking-wider lg:text-start  text-3xl lg:leading-normal bg-gradient-to-r from-[#F68082] to-[#97F4F3] bg-clip-text font-orbitron text-transparent"
        />
        <AnimatedText
          text=" A Milestone for Innovative Projects"
          animation="fade"
          as="h1"
          className="font-bold   leading-[40px] tracking-wider text-center lg:text-start  text-2xl lg:leading-normal bg-gradient-to-l from-[#F68082] to-[#97F4F3] bg-clip-text font-orbitron text-transparent"
        />
      </div>

      <div className="grid lg:grid-cols-2 grid-cols-1 dark:bg-[#E1F0F8] py-8 rounded-2xl mt-10 mb-16 gap-6 px-6 lg:px-6">
