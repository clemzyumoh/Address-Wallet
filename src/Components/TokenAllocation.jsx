...
//shadow-[2px_2px_2px_#B0E6F8,-2px_-2px_2px_#bf9fff]
const TokenAllocation = () => {
  return (
    <div className="flex flex-col items-center  md:w-[70vw] w-full lg:w-[50vw] px-3 mx-5 md:p-8 py-5  rounded-2xl lg:p-5 md:space-y-8">
